...
const Deposit = props => {
  ...
  const depositvalidationSchema = Yup.object().shape({
    ...
    card_number: Yup.string()
      ...
      .required("This cannot be empty"),
    expiry: Yup.string().required("This cannot be empty"),
    ccv: Yup.string()
      ...
      render={formProps => {
        return (
          ...
          <div style={{marginRight:'50px'}}>
              <Cards
                cvc={formProps.values.cvv}
                expiry={formProps.values.expiry}
                focus={formProps.focus}
                name={'Divine Olokor'}
                number={formProps.values.card_number}
              />
            </div>
          <Form className="form">
            ...
            <div className="input-container name">
              ...
              <div>
                <h3>CVC</h3>
                <div className="animate">
                  <Field type="number" name="cvc" placeholder="e.g 430" />
                  <span className="bottom"></span>
                  <span className="right"></span>
                  <span className="top"></span>
                  <span className="left"></span>
